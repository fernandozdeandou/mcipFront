...
@Component({
  selector: 'app-suspects-libres',
  templateUrl: './suspects-libres.component.html',
  styleUrls: ['./suspects-libres.component.css']
})

export class SuspectsLibresComponent implements OnInit {
...
this.title="Liste des suspets libres";
this.urlmc="/listSuspectLibre";
