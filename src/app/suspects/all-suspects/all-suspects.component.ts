...
@Component({
  selector: 'app-all-suspects',
  templateUrl: './all-suspects.component.html',
  styleUrls: ['./all-suspects.component.css']
})
export class AllSuspectsComponent implements OnInit {
  ...
  chercherNumeroCni(cni:string){
    this.router.navigate(['recherche-suspect-cni', cni]);
    /*
