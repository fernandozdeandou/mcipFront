...
@Component({
  selector: 'app-suspects-rechercher',
  templateUrl: './suspects-rechercher.component.html',
  styleUrls: ['./suspects-rechercher.component.css']
})
export class SuspectsRechercherComponent implements OnInit {
  public suspects;
  public title:string;
  private message;
...
this.urlmc="/listSuspectRechercher";
