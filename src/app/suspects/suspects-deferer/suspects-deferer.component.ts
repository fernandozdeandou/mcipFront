...
@Component({
  selector: 'app-suspects-deferer',
  templateUrl: './suspects-deferer.component.html',
  styleUrls: ['./suspects-deferer.component.css']
})
export class SuspectsDefererComponent implements OnInit {
