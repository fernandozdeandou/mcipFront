...
@Component({
  selector: 'app-personnel-permissionnaire',
  templateUrl: './personnel-permissionnaire.component.html',
  styleUrls: ['./personnel-permissionnaire.component.css']
})
export class PersonnelPermissionnaireComponent implements OnInit {
  ...
  ngOnInit() {
    this.mode=1;
    this.title="Liste du personnel permissionaire";
