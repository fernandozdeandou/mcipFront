...
@Component({
  selector: 'app-personnel-malade',
  templateUrl: './personnel-malade.component.html',
  styleUrls: ['./personnel-malade.component.css']
})
export class PersonnelMaladeComponent implements OnInit {
