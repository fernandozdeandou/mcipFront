...
@Component({
  selector: 'app-all-personnel',
  templateUrl: './all-personnel.component.html',
  styleUrls: ['./all-personnel.component.css']
})
export class AllPersonnelComponent implements OnInit {
