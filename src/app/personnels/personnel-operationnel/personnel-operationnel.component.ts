...
@Component({
  selector: 'app-personnel-operationnel',
  templateUrl: './personnel-operationnel.component.html',
  styleUrls: ['./personnel-operationnel.component.css']
})
export class PersonnelOperationnelComponent implements OnInit {
